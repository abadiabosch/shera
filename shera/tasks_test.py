...
class TestShera(unittest.TestCase):
    def assertAlmostEqualPDF(self, obtained, expected):
        ...
        expected_ = f.read()
        f.close() 
        self.assertEqual(len(obtained_), len(expected_))
    ...
    def _test_deliver(self, test_name):
        ...
        tasks.deliver_reports(setupo, contracts, reports, template, self.tempdir)
    ...
    def test_ok_single(self):
        ...
        self.assertEqualReportsData(sent_reports, 'test_ok_single', ['1111'])
    ...
    def test_ok_two(self):
        ...
        self.assertEqualReportsData(sent_reports, 'test_ok_two', ['1111','2222'])
    ...
    def test_donotdeliver_two(self):
        ...
        self.assertEqualReportsData(sent_reports, 'test_donotdeliver_two', ['1111','2222'])
        self.assertEqualReportsData(sent_reports, 'test_donotdeliver_two', ['1111','2222'])
    ...
    def _test_field_missing(self, field):
        ...
        self.assertEqualReportsData(sent_reports, test_name, ['1111'])
    ...
    def test_report_file_missing(self):
        ...
        self.assertAlmostEqualPDF(obtained, expected)
        self.assertReportNotCreated(self.tempdir, '2222.pdf')
        self.assertEqualReportsData(sent_reports, 'test_report_file_missing', ['1111'])

    def test_mako_notvalid(self):
        self._test_deliver('test_mako_notvalid')
        self.assertReportNotCreated(self.tempdir, '1111.pdf')
        self.assertReportNotCreated(self.tempdir, '2222.pdf')
        self.assertEqualReportsData(sent_reports, 'test_mako_notvalid', [])
    ...
    def test_contractid_notexists(self):
        ...
        self.assertAlmostEqualPDF(obtained[0], expected[0])
        self.assertAlmostEqualPDF(obtained[1], expected[1])
        self.assertEqualReportsData(sent_reports, 'test_contractid_notexists', ['1111','2222'])
